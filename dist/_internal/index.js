...
var configContext12s = require('./config-context-12s-BXAm5QZy.js');
...
const useSWRConfig = ()=>{
    return configContext12s.mergeObjects(configContext12s.defaultConfig, React.useContext(configContext12s.SWRConfigContext));
};
